...
#сравнение городских электросамокатах
...
characteristics = sorted(electric_scooters_detailed[models[0]].keys())

char = []
for model in models:
    char.append([electric_scooters_detailed[model][ch] for ch in characteristics])
...
create_radial(models, characteristics, get_normal(char))